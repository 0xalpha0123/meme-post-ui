...
const Input = (props: InputProps) => {
  ...
  return (
    <div
      className={`${className} transition-all duration-100 focus:transition-none flex w-full ${
    ...
    >
      ...
      <div className="relative flex">
        <input
          value={props.value}
          className={`border transition-all duration-100 focus:transition-none text-sm rounded-lg block w-full p-2.5 ${
